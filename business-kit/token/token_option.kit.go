...
type SigningSecretFunc func(ctx context.Context, tokenType commonv1.TokenTypeEnum_TokenType, passwordHash string) string

// TokenTypeFunc 令牌类型
type TokenTypeFunc func(context.Context, TokenTypeMap) commonv1.TokenTypeEnum_TokenType
