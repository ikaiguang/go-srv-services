...
// QueryOneByUserUuid query one by id
func (s *userRepo) QueryOneByUserUuid(ctx context.Context, userUuid string) (dataModel *entities.User, isNotFound bool, err error) {
	dataModel = new(entities.User)
...
func (s *UserSlice) UpdateColumns() (columnList []string) {
	...
	columnList = []string{
		...
		"register_from=excluded.register_from",
	}
	return columnList
}
