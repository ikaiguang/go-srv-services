...
func (s *UserRegMobile) CreateTableMigrator(migrator gorm.Migrator) migrationutil.MigrationInterface {
	return migrationutil.NewCreateTable(migrator, migrationutil.Version, s)
}

// DropTableMigrator create table migrator
func (s *UserRegMobile) DropTableMigrator(migrator gorm.Migrator) migrationutil.MigrationInterface {
