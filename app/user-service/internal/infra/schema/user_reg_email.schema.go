...
func (s *UserRegEmail) CreateTableMigrator(migrator gorm.Migrator) migrationutil.MigrationInterface {
	return migrationutil.NewCreateTable(migrator, migrationutil.Version, s)
}

// DropTableMigrator create table migrator
func (s *UserRegEmail) DropTableMigrator(migrator gorm.Migrator) migrationutil.MigrationInterface {
