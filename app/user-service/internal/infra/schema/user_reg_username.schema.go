...
func (s *UserRegUsername) CreateTableMigrator(migrator gorm.Migrator) migrationutil.MigrationInterface {
	return migrationutil.NewCreateTable(migrator, migrationutil.Version, s)
}

// DropTableMigrator create table migrator
func (s *UserRegUsername) DropTableMigrator(migrator gorm.Migrator) migrationutil.MigrationInterface {
