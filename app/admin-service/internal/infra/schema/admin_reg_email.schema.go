...
func (s *AdminRegEmail) CreateTableMigrator(migrator gorm.Migrator) migrationutil.MigrationInterface {
	return migrationutil.NewCreateTable(migrator, migrationutil.Version, s)
}

// DropTableMigrator create table migrator
func (s *AdminRegEmail) DropTableMigrator(migrator gorm.Migrator) migrationutil.MigrationInterface {
