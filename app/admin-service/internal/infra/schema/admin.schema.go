...
func (s *Admin) CreateTableMigrator(migrator gorm.Migrator) migrationutil.MigrationInterface {
	return migrationutil.NewCreateTable(migrator, migrationutil.Version, s)
}

// DropTableMigrator create table migrator
func (s *Admin) DropTableMigrator(migrator gorm.Migrator) migrationutil.MigrationInterface {
