...
func (s *AdminRegMobile) CreateTableMigrator(migrator gorm.Migrator) migrationuitl.MigrationRepo {
	return migrationuitl.NewCreateTable(migrator, s)
}

// DropTableMigrator create table migrator
func (s *AdminRegMobile) DropTableMigrator(migrator gorm.Migrator) migrationuitl.MigrationRepo {
